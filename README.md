...
## Open Research
    ...
    6. California Department of Water Resources Data Exchange Center for original runoff classes (https://cdec.water.ca.gov/reportapp/javareports?name=WSIHIST), 
...
## Native Land Acknowledgement
    The Legal Delta as it is known comprises of 5 Counties: Contra Costa, Sacramento, San Joaquin, Solano and Yolo, and a sixth partially: Alameda County.
    Overlapping these Counties and the Legal Delta are known historic lands stewarded by Indigenous Tribes, namely: Me-Wuk, Patwin, and Yokuts, but the list goes further.
    Educate yourself and your research partners on Native Lands and acknowledgments, keeping in step with CARE principles: Collective Benefits, Authority to Control, Responsibility, Ethics
